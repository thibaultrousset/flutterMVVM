    ...
    return Column(
      ...
      children: <Widget>[
        Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            (media != null && widget.mediaList.indexOf(media) != 0) ||
                    (widget.mediaList.isNotEmpty && media == null)
                ? IconButton(
                    onPressed: () {
                      media != null
                          ? widget.function2(widget
                              .mediaList[widget.mediaList.indexOf(media) - 1])
                          : null;
                    },
                    icon: Icon(
                      //Icons.skip_previous,
            ...
            IconButton(
              onPressed: (media != null &&
                          widget.mediaList.indexOf(media) !=
